#!/bin/bash
#SBATCH --job-name=prompts_aaronson_watermarked      # Job name
#SBATCH --output=prompts_aaronson_watermarked.log   # Output log file
#SBATCH --error=error_prompts_aaronson_watermarked.log  # Error log file
