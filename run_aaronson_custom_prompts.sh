#!/bin/bash
#SBATCH --job-name=aaronson_custom      # Job name
#SBATCH --output=aaronson_custom.log   # Output log file
#SBATCH --error=aaronson_custom_error.log   # Error log file
...
{"input": "Describe your ideal vacation destination.", "context": "", "outputs": [], "dataset": "custom", "_id": "9"}
{"input": "Write a creative story about a robot learning to feel emotions.", "context": "", "outputs": [], "dataset": "custom", "_id": "10"}
{"input": "Explain the theory of relativity in layman's terms.", "context": "", "outputs": [], "dataset": "custom", "_id": "11"}
{"input": "What are the key principles of good leadership?", "context": "", "outputs": [], "dataset": "custom", "_id": "12"}
{"input": "Describe the life cycle of a butterfly.", "context": "", "outputs": [], "dataset": "custom", "_id": "13"}
{"input": "Write a dialogue between two characters meeting for the first time.", "context": "", "outputs": [], "dataset": "custom", "_id": "14"}
{"input": "Explain the importance of biodiversity.", "context": "", "outputs": [], "dataset": "custom", "_id": "15"}
{"input": "What are the pros and cons of social media?", "context": "", "outputs": [], "dataset": "custom", "_id": "16"}
{"input": "Describe the process of evolution by natural selection.", "context": "", "outputs": [], "dataset": "custom", "_id": "17"}
{"input": "Write a story about time travel.", "context": "", "outputs": [], "dataset": "custom", "_id": "18"}
EOF
